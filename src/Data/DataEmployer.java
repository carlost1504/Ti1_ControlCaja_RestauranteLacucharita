...
public class DataEmployer {
	...
	public DataEmployer() {
		...
		try {
			...
			String DataOder_txt="C:\\Users\\carlo\\eclipse-workspace\\seguimiento_3\\RestauranteLacucharita\\src\\Data\\DataEmployer.txt";
			...
			while (!(line==null)){
				...
				if(line!=null) {
					...
					if(array[2].getBytes().equals("false")) {
						valido=false;
						p=new Employer(array[0], array[1], array[2], array[3]);
						employer.add(p);
